module BasicTypeProviderImplementation
...
type BasicErasingProvider (config : TypeProviderConfig) as this =
    inherit TypeProviderForNamespaces (config, assemblyReplacementMap=[("RpcTypeProvider.DesignTime", "RpcTypeProvider.Runtime")], addDefaultProbingLocation=true)
